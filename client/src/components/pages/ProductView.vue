    ...
    <div v-else-if="product">
        ...
        <div class="row">
            ...
            <div class="col-xl-7 col-md-12 m-auto">
                ...
                <h5 class="text-info">
                    Dish offered from:
                    <span class="text-dark font-weight-bold">{{ product.restaurant }}</span>
                </h5>
                <h5 class="text-info">
                    Price:
                ...
                <button :disabled='product.stock <= 0'  @click="addToCart(product)" class="btn" :class="[{'btn-outline-warning': product.stock > 0}, {'btn-danger': product.stock <= 0}]">
                    <span v-if="!hasCarted(product._id) && product.stock > 0">Add to Cart <i  class="fal fa-cart-arrow-down"></i></span>
